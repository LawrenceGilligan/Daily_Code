...
Algorithm Description: The algorithm exploits the fact that for any pair of numbers a and b, if a + b = k, then k - a = b. By storing the complements encountered so far in a set, we can efficiently check if the complement of the current number has already been encountered. 
"""
